...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link <?= $page_header == 'Dashboard' ? "" : "collapsed" ?>" href="/dashboard">
          <i class="bi bi-grid"></i>
          <span>Dashboard</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?= $page_header == 'Categories' ? "" : "collapsed" ?>" href="/categories">
          <i class="bi bi-layers"></i>
          <span>Categories</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?= $page_header == 'Expenses' ? "" : "collapsed" ?>" href="/expenses">
