...
<a role="button" class="btn btn-danger" href="/admin/archived/users">
    Archived Users
</a>
 </div>
<div class="d-flex justify-content-end mb-3">
    ...
    <div class="card-body">
        ...
        <?php foreach ($users as $user): ?>
            ...
            <td>
                ...
                <a role="button" href="/admin/users/<?php echo $user['id']; ?>" class="btn btn-primary"><i class="bi bi-eye me-1"></i></a>
            ...
            <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Update <?php echo $user['username']; ?></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
